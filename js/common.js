...
$(document).ready(function () {
    ...
    // package
    (function () {
        var packages = $('.js-package-1'),
            sliderPackage = packages.find('.js-package-1-slider');
        sliderPackage.slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            dots: true,
            arrows: true,
            prevArrow: sliderPackage.closest('.js-package-1').find('.js-package-1-prev'),
            nextArrow: sliderPackage.closest('.js-package-1').find('.js-package-1-next'),
            speed: 700,
            fade: true,
            adaptiveHeight: true,
            responsive: [{
        ...
        var packages = $('.js-package-2'),
            sliderPackage = packages.find('.js-package-2-slider');
        sliderPackage.slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            dots: true,
            arrows: true,
            prevArrow: sliderPackage.closest('.js-package-2').find('.js-package-2-prev'),
            nextArrow: sliderPackage.closest('.js-package-2').find('.js-package-2-next'),
            speed: 700,
            fade: true,
            adaptiveHeight: true,
            responsive: [{
        ...
        var packages = $('.js-package-3'),
            sliderPackage = packages.find('.js-package-3-slider');
        sliderPackage.slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            dots: true,
            arrows: true,
            prevArrow: sliderPackage.closest('.js-package-3').find('.js-package-3-prev'),
            nextArrow: sliderPackage.closest('.js-package-3').find('.js-package-3-next'),
            speed: 700,
            fade: true,
            adaptiveHeight: true,
            responsive: [{
